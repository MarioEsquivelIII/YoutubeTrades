...
export const KNOWN: Record<string, KnownEntry> = {
  ...
  NIO: { name: "NIO", aliases: ["nio inc", "nio stock"], trends: ["ev"] },
  RIVN: { name: "Rivian Automotive", aliases: ["rivian automotive", "rivian"], trends: ["ev"] },
  LCID: { name: "Lucid Group", aliases: ["lucid motors", "lucid group", "lucid ev"], trends: ["ev"] },
  XPEV: { name: "XPeng", aliases: ["xpeng motors", "xpeng"], trends: ["ev"] },
  LI: { name: "Li Auto", aliases: ["li auto"], trends: ["ev"] },
  PSNY: { name: "Polestar Automotive", aliases: ["polestar"], trends: ["ev"] },
  FSR: { name: "Fisker", aliases: ["fisker"], trends: ["ev"] },
  WKHS: { name: "Workhorse Group", aliases: ["workhorse"], trends: ["ev"] },
  ...
  IREN: { name: "Iris Energy", aliases: ["iris energy"], trends: ["ai"] },
  CORE: { name: "Core Scientific", aliases: ["core scientific"], trends: ["ai", "crypto"] },
  GOOG: { name: "Alphabet (Class C)", aliases: [], trends: ["ai", "cloud"] },
  // Cloud / Software
  ...
  ACHR: { name: "Archer Aviation", aliases: ["archer aviation"], trends: ["space", "robotics"] },
  JOBY: { name: "Joby Aviation", aliases: ["joby aviation", "joby"], trends: ["robotics"] },
  FIG: { name: "Forge Global", aliases: ["forge global"] },
  DXYZ: { name: "Destiny Tech100", aliases: ["destiny tech"] },
  // Biotech & GLP-1
